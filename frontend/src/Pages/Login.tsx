...
const Login = () => {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center">
     ...
     ( <form onSubmit={(e)=>handleFormSubmit(e)} className="w-[80%] h-[100%] max-h-[440px] max-w-[600px] bg-[#00000010] backdrop-blur shadow-lg shadow-[#023846] flex flex-col items-center justify-start py-12 gap-8 rounded-[8px] animated-form px-4 overflow-y-scroll">
        <h1 className="text-white text-lg font-semibold mb-8">Welcome to <span className="text-blue-400 text-xl font-semibold brand">ECHOE</span></h1>
  ...
  Submit
    ...
    <p className="text-white text-sm font-semibold">Don't have an Account ? <span className="text-blue-400 text-md font-semibold cursor-pointer" onClick={()=>navigate("/signup")}>Sign Up</span></p>
